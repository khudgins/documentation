...
An Enstratius tier is a component that can have services (software) tied to it. The tier
...
Adding the first tier prompts Enstratius to create a placeholder for a launch
configuration. 
